...
unsigned char
    passcode[4] = {} // TODO: for exercise 2 and 3, the initial passcode
should be up,
    down, left,
    right unsigned char SetBit(unsigned char x, unsigned char k,
                               unsigned char b) {
...
// direction and a
neutral int directions[5] =
    {}; // TODO: complete the array containg the values needed for
the 7 segments for each of the 4 directions
// a b c d e f g
//TODO: display the direction to the 7-seg display. HINT: will be very similar to
outNum()
void outDir(int dir){
}
