    ...
    \item Given (M = 764), show the expression, the decrypted integer, and the char it is mapped to.
      ...
      \item M = 764$^{3703}$ (mod 4453) = 29
        \begin{itemize}
          ...
          \item $764(764)^{1851\cdot2}$
          \item $2^2\cdot191(2^4\cdot 191^2)^{1851}$
          \item $191^2$ (mod 4453) = 857
          \item $2^2\cdot191(2^4\cdot857)^{1851}$
          \item $2^6\cdot191\cdot857(2^4\cdot857)^{1850}$
          \item 191\cdot857 = 163687 (mod 4453) \Rightarrow 163687 - 4453*36 = 3379
          \item $2^6\cdot3379(2^4\cdot857)^{1850}$
          \item $2^6\cdot3379(2\cdot2^3\cdot857)^{1850}$
          \item $2^3\cdot857$ = 6856 (mod 4453) \Rightarrow 6856 - 4453*1 = 2403
          \item $2^6\cdot3379(2\cdot2403)^{1850}$
          \item $2^6\cdot3379(2\cdot3^3\cdot89)^{1850}$
          \item 2\cdot3379(mod 4453) = 2305
          \item $2^5\cdot2305(2^2\cdot3^6\cdot89^2)^{925}$
          \item $2^5\cdot2305(2^2\cdot3^6\cdot3468)^{925}$
          \item $2^5\cdot5\cdot461(2^4\cdot3^7\cdot17^2)^{925}$
          \item $2^9\cdot3^7\cdot5\cdot461\cdot17^2(2^4\cdot3^7\cdot17^2)^{924}$
          \item $2^9\cdot3^7\cdot5\cdot461\cdot17^2(2^{16}\cdot3^{28}\cdot17^{4})^{231}$
          \item $17^3$ = 4913 (mod 4453) \Rightarrow 4913 - 4453 = 460 = $2^2\cdot5\cdot23$
          \item $2^9\cdot3^7\cdot5\cdot461\cdot17^2(2^{18}\cdot3^{28}\cdot5\cdot17\cdot23)^{231}$
          \item 17\cdot23\cdot5\cdot3 = 5865 (mod 4453) \Rightarrow 5865 - 4453 = 1412 = 353\cdot$2^2$
          \item $2^9\cdot3^7\cdot5\cdot461\cdot17^2(2^{20}\cdot3^{27}\cdot353)^{231}$
        \end{itemize}
